                          ...
                          <div class="panel panel-default">
                             <div class="panel-body">
                                ...
                                <form method="post" action="">
                                    ...
                                    @if ($image->featured)
                                        <button type="button" 
                                        class="btn btn-success btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imagen destacada actualemnte">
                                            <i class="material-icons">favorite</i>
                                        </button>
                                    @else
                                        <a href="{{ url('/admin/products/'.$product->id.'/images/select/'.$image->id) }}" 
                                        class="btn btn-white btn-fab btn-fab-mini btn-round" rel="tooltip" title="Destacar producto">
                                            <i class="material-icons">favorite</i>
                                        </a>
                                    @endif
